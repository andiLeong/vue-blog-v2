<template>
    <nav
        class="shadow bg-white dark:bg-gray-700"
        id="js-nav"
        :class="{ 'fixed top-0 w-full z-20': apply }"
    >
        <!-- desktop nav -->
        <div
            class="hidden max-w-6xl mx-auto sm:flex justify-between px-8 lg:px-6 h-16"
        >
            <div class="flex space-x-8">
                <AppLink
                    ...
                    :to="route"
                    :key="index"
                    class="inline-flex items-center text-gray-500 hover:text-gray-700 dark:text-white"
                >
