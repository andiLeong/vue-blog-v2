    ...
    <div v-for="(experience,index) in experiences" :key="index">
        ...
        <div class="space-y-4 md:space-y-0 md:grid gap-4 grid-cols-4">
            <div class="space-y-2">
                ...
                <input v-model="experience.position" placeholder="Position You Were In" required type="text"
                       class="form-input"/>
            </div>
            ...
            <div class="space-y-2">
                ...
                <input v-model="experience.company" placeholder="Your X company's name" required type="text"
                       class="form-input"/>
            </div>
