<template>
    <div class="relative py-14 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div
            class="h-8 bg-gradient-to-b dark:from-gray-800 from-gray-50 sticky top-0"
        ></div>
        <div v-if="post" class="text-lg">
            ...
            <p
                class="text-center text-xs mt-4 text-gryay-600 dark:text-gray-400"
            >
                {{ published_at }}
            </p>
