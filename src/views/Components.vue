<template>
    <section
        style="display: grid; place-items: center; height: 70vh; width: 100%"
    >
        <ul class="space-y-1">
            <li v-for="component in components" :key="component.description">
                <a class="text-blue-500" :href="component.url">{{
...
const components = ref([
    {
        description: 'Fix To Top',
        name: { name: 'fix.to.top' },
        url: '/fix-to-top',
    },
    {
        description: 'When Visible',
        name: { name: 'when.visible' },
        url: '/when-visible',
    },
    ...
    { description: 'Graph animation', url: '/graph' },
]);
